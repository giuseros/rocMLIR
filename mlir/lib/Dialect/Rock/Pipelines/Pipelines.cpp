...
void rock::buildBufferizePipeline(OpPassManager &pm,
  ...
  bufOpts.setFunctionBoundaryTypeConversion(bufferization::LayoutMapOption::IdentityLayoutMap);
...
void rock::buildBackendPipeline(OpPassManager &pm,
  ...
  pm.addNestedPass<gpu::GPUModuleOp>(createGpuSerializeToHsacoPass(options.triple, options.chip,
